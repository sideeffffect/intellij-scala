...
final class TrailingCommaPanel(settings: CodeStyleSettings) extends ScalaCodeStyleSubPanelBase(settings) {
  ...
  private val scopeFields: ListMap[String, String] = ListMap(
    ...
    ("TRAILING_COMMA_NAMED_TUPLE_ENABLED", ScalaBundle.message("trailing.comma.panel.scope.named.tuple")),
    ("TRAILING_COMMA_TUPLE_TYPE_ENABLED", ScalaBundle.message("trailing.comma.panel.scope.tuple.type")),
    ("TRAILING_COMMA_NAMED_TUPLE_TYPE_ENABLED", ScalaBundle.message("trailing.comma.panel.scope.named.tuple.type")),
    ("TRAILING_COMMA_NAMED_TUPLE_PATTERN_ENABLED", ScalaBundle.message("trailing.comma.panel.scope.named.tuple.pattern")),
